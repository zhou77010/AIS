...
Market answers a question about context, and the honest answer today is narrow: the
only measurement connected is how the broad market has moved over a year. The
insight says what that means and says nothing about sectors, styles or rates,
because none of them are connected and an interpretation of a measurement AIS does
